...
//         {
//             StartHandle(position, rotation);
//             var halfExtents = new float3(shape.shapeData.halfExtents.X, shape.shapeData.halfExtents.Y, shape.shapeData.halfExtents.Z);
//             var clampedConvexRadius = math.clamp(shape.convexRadius, 0f, math.cmin(halfExtents));
//
//             if (clampedConvexRadius == 0f)
//             {
//                 Handles.DrawWireCube(float3.zero, halfExtents * 2f);
//             }
//             else
//             {
//                 DrawRoundedWireCube(float3.zero, halfExtents * 2f, clampedConvexRadius);
//             }
//
//             ResetHandle();
//         }
...
//         // }
//         //
//         // public static void DrawTaperedCapsuleShape(float3 position, quaternion rotation,
//         //     PhysicsShapeTaperedCapsule shape)
//         // {
//         //     StartHandle(position, rotation);
//         //
