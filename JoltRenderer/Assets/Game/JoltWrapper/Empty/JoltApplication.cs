...
//
//
//         private List<IJoltSystem<JoltApplication, LogicLooperActionContext, JoltPhysicsWorld>> systems;
//
...
//
//             // 获取所有System
//             systems = new List<IJoltSystem<JoltApplication, LogicLooperActionContext, JoltPhysicsWorld>>(
//                 GetComponents<IJoltSystem<JoltApplication, LogicLooperActionContext, JoltPhysicsWorld>>()
//             );
//
...
//             //     foreach (var system in systems)
//             //     {
//             //         system.BeforePhysicsUpdate(in ctx);
//             //     }
//             //
...
//             //     foreach (var system in systems)
//             //     {
//             //         system.AfterPhysicsUpdate(in ctx);
//             //     }
//             //
//             //     return true;
//             // }));
