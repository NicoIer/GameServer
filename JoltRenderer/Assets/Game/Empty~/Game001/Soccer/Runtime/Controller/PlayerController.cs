...
namespace Soccer
{
    ...
    // , InputSystem_Actions.IPlayerActions
    {
        ...
        [Sirenix.OdinInspector.ShowInInspector] private bool isGrounded => body.isGrounded;
        private void Awake()
        {
            inputSystemActions = new InputSystem_Actions();

            actions.Attack.performed += PerformedAttack;
        ...
        private void PerformedAttack(InputAction.CallbackContext ctx)
        {
            // 鼠标 隐藏
            // if (isLocalPlayer)
            // {
